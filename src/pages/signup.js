    ...
    if (!usernameExists) {
      try {
        await createUserWithEmailAndPassword(auth, emailAddress, password).then(
          (userCredential) => {
            // Signed up
            const createdUserResult = userCredential.user;
            userId = createdUserResult.uid;
        ...
        await addDoc(collection(firebase, 'users'), {
          ...
          console.log('Use profile document created successfully');
        });
  ...
  return (
    <div className="container flex mx-auto max-w-screen-md items-center h-screen">
      ...
      <div className="flex flex-col w-2/5">
        <div className="flex flex-col items-center bg-white p-4 border border-gray-primary mb-4 rounded-3xl">
